		...
		<table>
			<c:choose>
				...
				<c:otherwise>
					...
					<tr>
						<th>Nickname</th>
						<td colspan="2"><input value="${memberdto. }" type="text" name="membernickname" placeholder="사용하실 닉네임을 입력해주세요. (한글 6자 이내)" required="required"/></td>
					</tr>
					<tr>
						<th>Name</th>
						<td colspan="2"><input value="" type="text" name="membername" placeholder="성함을 입력해주세요." maxlength="10" required="required"/></td>
					</tr>
					<tr>
						<th>Birthday</th>
						<td colspan="2"><input value="" type="date" name="memberbirth" placeholder="생년월일(YYYYMMDD)을 입력해주세요. (ex.'20200101')" maxlength="8" required="required"/></td>
					</tr>
					<tr>
						<th>Phone</th>
						<td colspan="2"><input type="tel" name="memberphone" placeholder="'-'를 사용해서 전화번호를 입력해주세요. (ex.'010-0000-0000')" maxlength="13" required="required"/></td>
					...
					<tr>
						<th>Email</th>
						<td colspan="2"><input value="" type="email" name="memberemail" placeholder="이메일을 입력해주세요." required="required"/></td>
					</tr>
				</c:otherwise>
			</c:choose>
		</table><br/>
