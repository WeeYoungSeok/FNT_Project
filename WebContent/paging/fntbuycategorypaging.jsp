...
<c:forEach begin="${param.beginPage}" end="${param.endPage}" step="1" var="index">
    <c:choose>
        ...
        <c:otherwise>
            <div class="otherpage"><a style="text-decoration:none; color:black;" href="${action}?page=${index}&command=buysearchlist&categorylist=${param.dcategory}&search=${param.search}">${index}</a></div>
        </c:otherwise>
    </c:choose>
</c:forEach>
