        ...
        $.ajax({
            ...
            success:function(data){
            		...
            		$.each(CompanyArray,function(key,value) {
	            			...
	            			//myData += ('<button type=hidden>'+value.key+'/'+value.Code+'/'+value.Name+'</button>');
            		});
            ...
            $.ajax({
                ...
                success:function(data){
                	...
                	if(data.status == false){
	            		...
	            		myInvoiceData += ('<tr>');            	
	            		myInvoiceData += ('<th>'+"받는사람주소"+'</td>');     				
	            		myInvoiceData += ('<th>'+data.receiverAddr+'</td>');
	            		myInvoiceData += ('</tr>'); 
	            		
	            		myInvoiceData += ('<tr>'); 
	            		myInvoiceData += ('<th>'+"기사메세지"+'</td>');     				
	            		myInvoiceData += ('<th>'+data.recipient+'</td>');
	            		myInvoiceData += ('</tr>'); 
