...
CREATE TABLE DEAL_BOARD(
   ...
   D_FILENAME VARCHAR2(50) NOT NULL,
...
DROP SEQUENCE RB_BOARDNO_SEQ;

CREATE SEQUENCE RB_BOARDNO_SEQ;

CREATE TABLE REPLY_BOARD(
   RB_BOARDNO NUMBER NOT NULL,
   RB_ID VARCHAR2(10) NOT NULL,
   RB_GROUPNO NUMBER NOT NULL,
   RB_GROUPSEQ NUMBER NOT NULL,
   RB_TITLETAB VARCHAR2(10) NOT NULL,
   -- TITLETAB 1로 고정
   RB_TITLE VARCHAR2(50) NOT NULL,
   RB_CONTENT VARCHAR2(3000) NOT NULL,
   RE_REGDATE DATE NOT NULL,
   
   CONSTRAINT RB_BOARDNO_PK PRIMARY KEY(RB_BOARDNO),
   FOREIGN KEY(RB_ID) REFERENCES MEMBER(MEMBER_ID)
);
